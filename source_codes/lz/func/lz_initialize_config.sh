#!/bin/sh
# lz_initialize_config.sh v3.7.8
...
## 第一WAN口用户自定义源网址/网段至目标网址/网段流量出口列表绑定
## 0--启用；非0--禁用；取值范围：0~9
## 缺省为禁用（5）。
...
## 第二WAN口用户自定义源网址/网段至目标网址/网段流量出口列表绑定
## 0--启用；非0--禁用；取值范围：0~9
## 缺省为禁用（5）。
...
## 第一WAN口用户自定义源网址/网段至目标网址/网段高优先级流量出口列表绑定
## 0--启用；非0--禁用；取值范围：0~9
## 缺省为禁用（5）。
